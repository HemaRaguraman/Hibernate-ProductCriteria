...
public class ProductCriteria {
	...
	public static void main(String[] args) {
		...
		for(Product prod: prodList) {
			System.out.println(prod.getSlno()+" "+ prod.pname+" "+prod.pquantity+" "+prod.price);
		}
		...
		prodList = (List<Product>) session.createCriteria(Product.class).add(Restrictions.gt("pquantity",10)).list();
		for(Product p3 : prodList) {
